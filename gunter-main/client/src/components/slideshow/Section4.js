...
import jpg480 from '../assets/images/thumb-480-700.jpg';
import job911 from '../assets/images/job-911.jpg';
                          ...
                          <div className="service_part">
                            <div className="owl-carousel">
                              ...
                              <div className="item">
                                <div className="img_holder">
                                  <img
                                    src="../assets/images/thumb-480-700.jpg"
                                    alt=""
                                  />
                                  <div
                                    className="abs_img"
                                    data-bg-img="../assets/images/Process-Skid.JPG"
                                  >
                                    <a href="#" />
                                  </div>
                                </div>
                                <div className="title">
                                  <h3>
                                    <a href="#">Process Skids</a>
                                  </h3>
                                </div>
                                <div className="view_more">
                                  <a href="myservice/automative-manufacturing/">
                                    <span className="text">View More</span>
                                    <span className="arrow">
                                      <img
                                        className="industify_w_fn_svg"
                                        src="../assets/images/svg/arrow-r.svg"
                                        alt="svg"
                                      />
                                    </span>
                                  </a>
                              ...
                              <div className="item">
                                <div className="img_holder">
                                  ...
                                  <div
                                    className="abs_img"
                                    data-bg-img="../assets/images/Custom-Vessel.JPG"
                                  >
                                    <a href="myservice/chemical-industry/" />
                                  </div>
                                </div>
                                <div className="title">
                                  <h3>
                              ...
                              <div className="item">
                                <div className="img_holder">
                                  ...
                                  >
                                    <a href="myservice/oil-and-gas-industry/" />
                                  </div>
                                </div>
                                <div className="title">
                                  <h3>
                              ...
                              <div className="item">
                                <div className="img_holder">
                                  ...
                                  >
                                    <a href="myservice/energy-commodities/" />
                                  </div>
                                </div>
                                <div className="title">
                                  <h3>
                              ...
                              <div className="item">
                                <div className="img_holder">
                                  ...
                                  <div
                                    className="abs_img"
                                    data-bg-img="../assets/images/sync-industries-medical.jpg"
                                  >
                                    <a href="myservice/medical-devices/" />
                                  </div>
                                </div>
                                <div className="title">
                                  <h3>
